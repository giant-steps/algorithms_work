...
substitution matrix was imported from


There was some ambiguity...         I interpreted the prompt as meaning that for any column in which there is a blank for
at least one sequence, we should disregard the column entirely in calculating entropy and sum of pairs.

To include this information in sum of pairs, ...
